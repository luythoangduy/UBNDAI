...
import type { CaseDetail, CaseDocument, CaseRecord, ChatAction, ChatExperience, ChatResponse, ChatStarterResponse, DashboardSummary, ExtractedField, PortalRole, PreprocessResult, PreprocessStep, ProcedureCapabilities, ProcedureFormSchema, ProcedureSummary } from './types';
import { buildCaseQuery, formatDate, humanizeStatus } from './utils';
import './styles.css';
...
import { ReviewWorkspace } from './features/officer-review/ReviewWorkspace';
import { procedureNames, rememberProcedureNames } from './features/officer-review/procedureCatalog';
...
function App() {
  ...
  return isManagementRoute ? <ApplicationManagementRouter /> : location.pathname.startsWith('/officer') ? <OfficerPortal/> : <CitizenPortal/>;
}
